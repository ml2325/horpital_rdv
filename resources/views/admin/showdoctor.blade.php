  ...
  <body>
    <div class="container-scroller">
     ...
     @include('admin.navbar')
        ...
        <div align="center" style="padding:100px;gap:3px">
          <table>
            ...
            <tr style="background-color:green;" align="center">
              ...
              <td><a href="{{url('deletedoctor',$doctor->id)}}"  onclick="return confirm('you really want to delete this doctor  think again !')" class="btn btn-danger">Delete</a></td>
